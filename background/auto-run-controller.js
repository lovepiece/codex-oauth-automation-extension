        ...
        while (attemptRun <= maxAttemptsForRound) {
          ...
          if (!useExistingProgress) {
            ...
            const keepSettings = {
              ...
              currentHeroSmsActivation: prevState.currentHeroSmsActivation || null,
              heroSmsLastCode: prevState.heroSmsLastCode || '',
              heroSmsRuntimeStatus: prevState.heroSmsRuntimeStatus || '',
              heroSmsActiveActivations: Array.isArray(prevState.heroSmsActiveActivations) ? prevState.heroSmsActiveActivations : [],
              heroSmsActiveActivationsFetchedAt: Number(prevState.heroSmsActiveActivationsFetchedAt) || 0,
              heroSmsFailedActivations: Array.isArray(prevState.heroSmsFailedActivations) ? prevState.heroSmsFailedActivations : [],
              heroSmsStandbyActivations: Array.isArray(prevState.heroSmsStandbyActivations) ? prevState.heroSmsStandbyActivations : [],
              heroSmsPendingSuccessActivationId: Number(prevState.heroSmsPendingSuccessActivationId) || 0,
              autoRunRoundSummaries: serializeAutoRunRoundSummaries(totalRuns, roundSummaries),
              autoRunSessionId: sessionId,
              tabRegistry: {},
              sourceLastUrls: {},
